  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-black text-white p-12 flex-col justify-between">
        <div>
          <h2 className="text-4xl font-bold mb-3 text-tan">
          ...
          <div className="space-y-4">
            {steps.map((step, index) => (
              <div key={step.title} className="bg-teal/5 backdrop-blur-xl rounded-xl p-6 border border-teal/20 transition-colors hover:bg-teal/10">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-tan rounded-lg flex items-center justify-center shrink-0">
                    <step.icon className="w-6 h-6 text-black" />
                  </div>
                  <div>
                    <h3 className="text-xl font-semibold mb-2 text-tan">{step.title}</h3>
        ...
        <div className="mt-8 flex items-center gap-4 text-sm text-gray-400">
          ...
          <Link href="/login" className="text-tan hover:text-teal transition-colors">
            Sign in
          </Link>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 bg-zinc-950 px-12 py-3 flex items-center justify-center">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-tan mb-2">Create Your Account</h2>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <div>
              ...
              <div className="relative">
                <User className="w-5 h-5 text-teal/70 absolute left-3 top-1/2 -translate-y-1/2" />
                <input
                  type="text"
                  id="fullName"
                  {...form.register("fullName")}
                  className="w-full pl-10 pr-4 py-3 bg-zinc-900 border border-zinc-800 rounded-lg focus:ring-2 focus:ring-teal focus:border-teal text-white placeholder-gray-500"
                  placeholder="Enter your full name"
                />
              </div>
              {form.formState.errors.fullName && (
                <p className="text-tan text-sm mt-1">{form.formState.errors.fullName.message}</p>
              )}
            </div>
            ...
            <div>
              ...
              {form.formState.errors.email && (
                <p className="text-tan text-sm mt-1">{form.formState.errors.email.message}</p>
              )}
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <Phone className="w-5 h-5 text-teal/70 absolute left-3 top-1/2 -translate-y-1/2" />
                <input
                  type="tel"
                  id="phone"
                  {...form.register("phone")}
              ...
              {form.formState.errors.phone && (
                <p className="text-tan text-sm mt-1">{form.formState.errors.phone.message}</p>
              )}
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <Lock className="w-5 h-5 text-teal/70 absolute left-3 top-1/2 -translate-y-1/2" />
                <input
                  type="password"
                  id="password"
              ...
              {form.formState.errors.password && (
                <p className="text-tan text-sm mt-1">{form.formState.errors.password.message}</p>
              )}
            </div>
            ...
            <div>
              ...
              {form.formState.errors.confirmPassword && (
                <p className="text-tan text-sm mt-1">{form.formState.errors.confirmPassword.message}</p>
              )}
            </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-tan text-black py-3 rounded-lg font-medium hover:opacity-90 transition-all duration-300 flex items-center justify-center gap-2"
            >
          ...
          <p className="mt-6 text-center text-gray-400">
            ...
            <Link href="/login" className="text-tan hover:text-teal font-medium">
              Sign in
            </Link>
          </p>
        </div>
